...
var hsl = function (args) {
  ...
  var hue = tokens[0],
    ...
    alpha = tokens[3];
  var h =
    (hue.type === TokenType.NUMBER_TOKEN ? deg(hue.number) : angle.parse(hue)) /
    (Math.PI * 2);
...
(function (PropertyDescriptorParsingType) {
  PropertyDescriptorParsingType[(PropertyDescriptorParsingType['VALUE'] = 0)] =
    'VALUE';
          ...
          if (counter && isIdentToken(counter)) {
            ...
            var counterType_1 =
              counterStyle && isIdentToken(counterStyle)
                ...
                : LIST_STYLE_TYPE.DECIMAL;
            var separator =
              delim && delim.type === TokenType.STRING_TOKEN ? delim.value : '';
